...
//         image={displayImage}
//         name={displayTitle}
//         className={style.hi} // Removed shape prop
//       />
//       <div className="str-chat__header-livestream-left str-chat__channel-header-end">
//         <p className="str-chat__header-livestream-left--title str-chat__channel-header-title">
//           {displayTitle}{' '}
...
import type { ChannelResponse } from 'stream-chat';
import { CreateCallButton, StreamChatType } from '../CreateCallButton';
import './ChannelHeader.css'; // Import the CSS file
  ...
  return (
    <div className="channel-header">
      ...
      <Avatar
        image={displayImage}
        name={displayTitle}
        className="avatar" // Apply class name
      />
      <div className="str-chat__header-livestream-left str-chat__channel-header-end">
        <p className="title">
          {displayTitle}{' '}
        ...
        <p className="members str-chat__header-livestream-left--members str-chat__channel-header-info">
          {!live && !!member_count && member_count > 0 && (
            <>
              {t('{{ memberCount }} members', {
                memberCount: member_count,
